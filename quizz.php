...
if($isPosted){
    ...
    foreach($_POST as $rq){
        ...
        if($rightReply < 5){
            $message = "Votre score est de $rightReply / 10 il y a encore du travail";
        } elseif($rightReply >7){
            $message = "Félicitations votre score est de $rightReply / 10";
        } else {
            $message = "Votre score est de $rightReply / 10 continuez vos efforts";
        }
    }
}
?>
...
<html lang="fr">
    ...
    <body>
        ...
        <button class="btn btn-danger"><a href="http://localhost:8000/quizz.php">Retour au quizz</a></button>

        <div class="container-fluid">
            <div class="container">
                <h1 class="text-center jumbotron my-5">TP Quizz PHP correction
                <p><?= $message ?></p>
                </h1>
                <form method="post">
                        ...
                        <div class="container border border-dark my-3 py-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <ul>
                                        <?php if($item['rightReply'] == ($numeroQuestion . $countReply)) : ?>
